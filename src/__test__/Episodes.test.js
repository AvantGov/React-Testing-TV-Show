...
import { render } from '@testing-library/react'
    ...
    test('episodes are displayed when the props are passed to the component', () => {
        const {getAllByTestId} = render(<Episodes episodes={episodes_list} />)  

        expect(getAllByTestId('newtest')).toHaveLength(3)
