...
import {fetchShow as mockFetchShow } from '../utils/api.js'


test('renders fetching data message on initial mounting', () =>  {
    const { getByTestId } = render(<App />)

    const fetching = getByTestId("fetching")

    expect(fetching).toBeVisible()
}) 
...
// test('renders homepage elements on intiial api call', async ()  => {
